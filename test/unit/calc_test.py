...
class TestCalculate(unittest.TestCase):
    ...
    def test_logaritmo_method_returns_correct_result(self):
        self.assertEqual(2, self.calc.logaritmo(100))
    ...
    def test_logaritmo_method_fails_with_nan_parameter(self):
        ...
        self.assertRaises(TypeError, self.calc.logaritmo, -5)
        self.assertRaises(TypeError, self.calc.logaritmo, "2")
        self.assertRaises(TypeError, self.calc.logaritmo, None)
        self.assertRaises(TypeError, self.calc.logaritmo, object())
